...
import InputCheckBox from "../../../../components/form/input-check-box/InputCheckBox.js";
import {getPayrollOverideTypes,createCategories,getCategories} from "../../../../services/categoriesService.js";
const AddCategories = () => {
                ...
                <div className="formbold-main-wrapper">
                  ...
                  <div className="formbold-form-wrapper">
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          {
                            isEventcatEmailReminder?<LabelInputBox inputValue={eventcatEmailReminder} setInputValue={setEventcatEmailReminder} label={"Email Reminders"} onClear={()=>setIsEventcatEmailReminder(false)} unit={"Hours Before"} />:<SelectBox label={"Email Reminders"} options={timeList} onChangeSelect={eventcatEmailReminderOnchange}  />
                          }
                        </div>
                        <div className="col-md-6">
                          {
                            isEventcatSmsReminder?<LabelInputBox inputValue={eventcatSmsReminder} setInputValue={setEventcatSmsReminder} label={"SMS Reminders"} onClear={()=>setIsEventcatSmsReminder(false)} unit={"Hours Before"} />:<SelectBox label={"SMS Reminders"} options={timeList} onChangeSelect={eventcatSmsReminderOnChange}  />
                          }
