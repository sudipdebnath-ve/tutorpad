...
const EditLocations = () => {
  ...
  const [eventlocAddressDefaultValue, setEventlocAddressDefaultValue] =
    useState({});
  ...
  const getLocationsDetailsHandler = async () => {
    ...
    if (res.data) {
      ...
      setEventlocIconDefaultValue(
        iconLists.find((f) => f.value == res.data.eventloc_icon)
      );
      setEventlocAddress(res.data.eventloc_address);
      setEventlocAddressDefaultValue(
        addressList.find((f) => f.value == res.data.eventloc_address)
      );
                  ...
                  <div className="formbold-form-wrapper">
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <SelectBox
                          selectValue={eventlocIconDefaultValue}
                          label={"Icon"}
                          options={iconLists}
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <SelectBox
                          selectValue={eventlocAddressDefaultValue}
                          label={"Address"}
                          options={addressList}
