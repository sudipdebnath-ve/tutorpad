      ...
      <div className="sidebar-content js-simplebar">
        ...
        { role === `${process.env.REACT_APP_STUDENT_ROLE}` &&
          <ul className="sidebar-nav">
            ...
            <li
              className={`sidebar-item ${
                splitLocation[1] === "borrowing-library" ? "active" : ""
              }`}
            >
              <Link className="sidebar-link" to="/student/borrowing-library">
                <i className="fa fa-book" aria-hidden="true"></i>
                <span className="align-middle">{t("Borrowing Library")}</span>
              </Link>
            </li>
            ...
            <li
              className={`sidebar-item ${
                splitLocation[1] === "study-logs" ? "active" : ""
              }`}
            >
              <Link className="sidebar-link" to="/student/study-logs">
                <i className="fa fa-text-width" aria-hidden="true"></i>
                <span className="align-middle">{t("Study Logs")}</span>
              </Link>
            </li>
            <li
              className={`sidebar-item ${
                splitLocation[1] === "account-invoices" ? "active" : ""
              }`}
            >
              <Link className="sidebar-link" to="/student/account-invoices">
                <i className="fa fa-text-width" aria-hidden="true"></i>
                <span className="align-middle">{t("Account & Invoices")}</span>
              </Link>
            </li>
            <li
              className={`sidebar-item ${
                splitLocation[1] === "attendance-notes" ? "active" : ""
              }`}
            >
              <Link className="sidebar-link" to="/student/attendance-notes">
                <i className="fa fa-text-width" aria-hidden="true"></i>
                <span className="align-middle">{t("Attendance & Notes")}</span>
              </Link>
            </li>
            <li
              className={`sidebar-item ${
            ...
            <li
              className={`sidebar-item ${
                splitLocation[1] === "message-history" ? "active" : ""
              }`}
            >
              <Link className="sidebar-link" to="/student/message-history">
                <i className="fa fa-text-width" aria-hidden="true"></i>
                <span className="align-middle">{t("Message History")}</span>
              </Link>
            </li>
          </ul>
        }
