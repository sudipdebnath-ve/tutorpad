                    ...
                    {attendance_status != 1 && (
                      <div>
                          ...
                          {(attendance_status == 2 ||
                            ...
                            <label>
                              <input
                                ...
                                checked={
                                  billing_type == "used_makeup_credits"
                                    ? true
                                    : false
                                }
                                onChange={(e) =>
                                  set_billing_type(e.target.value)
                                }
                                name="billing_type"
                              />
                          ...
                          {attendance_status == 3 && (
                            <label>
                              <input
                                ...
                                value={"given_notice"}
                                checked={
                                  billing_type == "given_notice" ? true : false
                                }
                                onChange={(e) =>
                                  set_billing_type(e.target.value)
                                }
                          ...
                          {attendance_status == 4 && (
                            <label>
                              <input
                                ...
                                value={"not_billable"}
                                checked={
                                  billing_type == "not_billable" ? true : false
                                }
                                onChange={(e) =>
                                  set_billing_type(e.target.value)
                                }
                        ...
                        <div className="alert alert-warning">
                          Use Make-Up options are not available because Kumar,
                          Ramesh has insufficient credits (Kumar, Ramesh has 0
                          of 1 make-up credits required).
                        </div>
                          ...
                          {(billing_type == "lesson_is_billable" ||
                            ...
                            <label>
                              <input
                                ...
                                value={lesson_price}
                                onChange={(e) =>
                                  set_lesson_price(e.target.value)
                                }
                                name="lesson_price"
                              />
                            </label>
                            ...
                            billing_type == "lesson_is_billable" && (
                              <label>
                                <input
                                  ...
                                  onChange={(e) =>
                                    set_is_paid_at_lesson(e.target.checked)
                                  }
