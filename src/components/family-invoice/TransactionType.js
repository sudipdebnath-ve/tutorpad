...
const TransactionType = () => {
  ...
  return  <> 
          ...
          <div  className="payment-type-box">
              <div onClick={()=>navigate('/familiies-and-invoices/transaction-type/'+2+'/'+1)} className="type-box">
            ...
            <div onClick={()=>navigate('/familiies-and-invoices/transaction-type/'+2+'/'+2)} className="type-box">
          ...
          <div className="payment-type-box">
            <div onClick={()=>navigate('/familiies-and-invoices/transaction-type/'+2+'/'+3)} className="type-box">
            ...
            <div onClick={()=>navigate('/familiies-and-invoices/transaction-type/'+2+'/'+4)} className="type-box">
