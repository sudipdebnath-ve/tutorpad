...
const AutoInvoiceRepeatBox = ({event_frequency,set_event_frequency,event_repeat_on,set_event_repeat_on,event_frequency_val,set_event_frequency_val,event_repeat_indefinitely,set_event_repeat_indefinitely,event_repeat_until,set_event_repeat_until})=>{
